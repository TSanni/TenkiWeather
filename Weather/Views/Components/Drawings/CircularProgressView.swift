...
struct CircularProgressView: View {
    ...
    func convertPressureToCircleTrim() -> Double {
        ...
        if pressure < 29.4 { circleTrim = 0.1 }
        
        if pressure >= 29.4 && pressure < 29.8 { circleTrim = 0.3 }
        
        if pressure >= 29.8 && pressure < 30.2 { circleTrim = 0.4 }
        
        if pressure >= 30.2 && pressure <= 30.5 { circleTrim = 0.5 }
        
        if pressure > 30.5 { circleTrim = 0.8 }
