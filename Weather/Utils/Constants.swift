...
//        static let sunMaxColor = Color(uiColor: #colorLiteral(red: 0.1332838535, green: 0.6956239343, blue: 0.889532268, alpha: 1))
        ...
        static let moonAndStarsColor = Color.indigo
        static let cloudSunColor = Color(uiColor: #colorLiteral(red: 0.3795131445, green: 0.7058345675, blue: 0.8753471971, alpha: 1))
//        static let cloudSunColor = Color(uiColor: #colorLiteral(red: 0.231372549, green: 0.2823529412, blue: 0.3450980392, alpha: 1))
//        static let cloudMoonColor = Color(uiColor: #colorLiteral(red: 0.521438539, green: 0.5413015485, blue: 0.8576574922, alpha: 1))
        static let cloudMoonColor = Color(uiColor: #colorLiteral(red: 0.476841867, green: 0.5048075914, blue: 1, alpha: 1))
        static let partlyCloudyColor = Color(uiColor: #colorLiteral(red: 0.3795131445, green: 0.7058345675, blue: 0.8753471971, alpha: 1))
...
//        static let haze = Color(uiColor: #colorLiteral(red: 0.6361310482, green: 0.6071113944, blue: 0.5944020152, alpha: 1))
        static let haze = Color(uiColor: #colorLiteral(red: 0.5787474513, green: 0.3215198815, blue: 0, alpha: 1))
